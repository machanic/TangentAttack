...
def generate_attacked_dataset(dataset, num_sample, models):
    ...
    selected_img_id = []
    total_count = 0
    data_loader = DataLoaderMaker.get_imgid_img_label_data_loader(dataset, 1, is_train=False, shuffle=True)
...
if __name__ == "__main__":
    ...
    selected_images, selected_true_labels, selected_img_id = generate_attacked_dataset(dataset, 20, models)
