...
train_loader = DataLoaderMaker.get_imgid_img_label_data_loader(args.dataset, args.batch_size, True, True)
test_loader = DataLoaderMaker.get_imgid_img_label_data_loader(args.dataset, args.batch_size, False, False)
...
def train(args, model, device, train_loader, optimizer, epoch):
    ...
    for batch_idx, (_, data, target) in enumerate(train_loader):
        ...
        loss = trades_loss(model=model,
                           ...
                           beta=args.beta,distance=args.norm)
        loss.backward()
        optimizer.step()
