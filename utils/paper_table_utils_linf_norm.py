...
def draw_wide_tables_for_ImageNet(result, targeted_attack_result):
    print("""
...
if __name__ == "__main__":
    ...
    if "CIFAR" in dataset:
        ...
        archs = ["senet154","inceptionv3","inceptionv4","resnet101"]
    ...
    if "CIFAR" in dataset:
        ...
        draw_wide_tables_for_ImageNet_with_300_query(result_archs, targeted_result_archs)